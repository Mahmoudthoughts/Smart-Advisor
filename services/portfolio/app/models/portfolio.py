"""Portfolio domain models for the microservice."""
...
class Portfolio(Base):
    ...
    watchlist: Mapped[list["PortfolioSymbol"]] = relationship(back_populates="portfolio", cascade="all, delete-orphan")
    accounts: Mapped[list["PortfolioAccount"]] = relationship(back_populates="portfolio", cascade="all, delete-orphan")
